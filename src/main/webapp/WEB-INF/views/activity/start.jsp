...
<script>
    ...
    $(".form").attr("url", "/activity/process/getStartFormProperties/"+key);
    ...
    function generateForm(data) {
        ...
        $($("form")[0]).attr("action","/activity/process/startForm/"+key);
    }
    $.ajax({
        type: "GET",
        url: "/activity/process/getStartFormProperties/"+key,
        dataType: 'json',
